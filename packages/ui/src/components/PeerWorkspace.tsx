...
export function PeerWorkspace({ session, peerColor, onEdit }: Props) {
  ...
  const sectionTitle: React.CSSProperties = {
    fontWeight: 600, fontSize: 12, color: '#555', textTransform: 'uppercase',
    letterSpacing: '0.05em', marginBottom: 6, marginTop: 0,
  };
  ...
  return (
    <div style={{
      ...
      {/* Header */}
      <div style={{ background: peerColor, padding: '8px 12px', color: '#fff' }}>
