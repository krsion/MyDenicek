...
\begin{itemize}[noitemsep]
    \item Core library (\texttt{@mydenicek/core}) - CRDT operations
    \item React bindings (\texttt{@mydenicek/react}) - hooks and context
...
\begin{itemize}[noitemsep]
    \item \textbf{@mydenicek/core} - Core CRDT library wrapping Loro
    \item \textbf{@mydenicek/react} - React hooks and context providers
...
\textbf{MyDenicek Core Library} A fully functional TypeScript library (\texttt{@mydenicek/core}) providing:
\begin{itemize}[noitemsep]
...
\textbf{MyDenicek React Library} React bindings (\texttt{@mydenicek/react}) providing:
\begin{itemize}[noitemsep]
