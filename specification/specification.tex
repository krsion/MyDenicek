...
\begin{verbatim}
GeneralizedPatch {
    action: "put" | "del" | "insert" | "splice" | "inc" | "move" | "copy"
...
Recording is automatic---all document operations are captured in the Recorded History panel:
\begin{enumerate}
\item Perform operations (add, edit, delete, move nodes)
\item Recorder captures patches in real-time
